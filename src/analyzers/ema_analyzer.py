#!/usr/bin/env python3
"""
EMA 4H Analyzer - 21/50 EMA Crossovers + Zone Touch
"""
import os
import json
import sys
...
class EMAAnalyzer:
    ...
    def load_coins(self):
        """Load coins - same filtering as SMA"""
        ...
        try:
            ...
            print(f"📊 Loaded {len(filtered)} coins for EMA analysis")
            return filtered
    ...
    def run_analysis(self):
        """Main EMA analysis runner"""
        print("🟡 EMA 4H ANALYSIS - CROSSOVERS + ZONE TOUCH")
